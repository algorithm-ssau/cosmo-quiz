  ...
  if (isAvailable) {
    return (
      <div className="grid items-stretch h-48 grid-cols-5 rounded bg-gradient-to-b from-lightBlue to-darkBlue hover:ring-2 ring-gold">
        <div className="col-span-4 mt-5 ml-5 ">
          <div className="flex">
            {starsCount === 0 && (
              <div className="flex">
                <IoStar
                  className="place-self-center text-darkBlue"
                  size={"30px"}
                />
                <IoStar
                  className="place-self-center text-darkBlue"
            ...
            {isDone && (
              <IoIosCheckmarkCircle className="ml-2 text-white" size={"30px"} />
            )}
          </div>
        ...
        <div className="">
          <p className="mt-2 mr-4 text-5xl text-white opacity-50 text-end">
            {number}
          </p>
        </div>
      </div>
