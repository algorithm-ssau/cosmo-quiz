...
export default async function initDatabase() {
  ...
  let question = new Question({
    author: "Котельников Геннадий Петрович",
    whoAuthor: "Академик РАН, Председатель Самарской Думы",
    fullAuthor: Kotelnikov._id,
  ...
  question = new Question({
    author: "Степанова Анастасия Александрова",
    whoAuthor: "Участник «Марс 160», Испытатель-исследователь ",
    fullAuthor: Stepanova._id,
  ...
  question = new Question({
    author: "Виноградов Павел Владимирович",
    whoAuthor: "Герой РФ, Лётчик-космонавт",
    fullAuthor: Vinogradov._id,
    name: "Звездный сосед",
  ...
  question = new Question({
    author: "Прокопьев Сергей Валерьевич",
    whoAuthor: "Герой РФ, Лётчик-космонавт",
    name: "Космос-арена",
  ...
  question = new Question({
    author: "Лазаренко Александр Юрьевич",
  ...
  question = new Question({
    author: "Шкаплеров Антон Николаевич",
    whoAuthor: "Герой РФ, Лётчик-космонавт",
  ...
  question = new Question({
    author: "Лазуткин Александр Иванович",
    whoAuthor: "Герой РФ, Лётчик-космонавт",
    name: "К полету готов",
  ...
  question = new Question({
    author: "Королёв Андрей Вадимович",
  ...
  question = new Question({
    author: "Артемьев Олег Германович",
    whoAuthor: "Герой РФ, Лётчик-космонавт",
    name: "Трещин нет!",
  ...
  question = new Question({
    author: "Степанова Анастасия Александровна",
    whoAuthor: "Участник «Марс 160», Испытатель-исследователь",
  ...
  question = new Question({
    author: "Филатова Тамара Дмитриевна",
  ...
  question = new Question({
    author: "Даниленко Александра Николаевна",
  ...
  question = new Question({
    author: "Бабкин Андрей Николаевич",
  ...
  question = new Question({
    author: "Юрченко Екатерина Сергеевна",
  ...
  question = new Question({
    author: "Титов Владимир Георгиевич",
  ...
  question = new Question({
    author: "Черкасов Андрей Николаевич",
  ...
  question = new Question({
    author: "Корниенко Михаил Борисович",
    whoAuthor: "Герой РФ, Лётчик-космонавт",
    name: "Сила духа",
  ...
  question = new Question({
    author: "Королёва Наталия Сергеевна",
  ...
  question = new Question({
    author: "Сойфер Виктор Александрович",
  ...
  question = new Question({
    author: "Корзун Валерий Григорьевич",
    whoAuthor: "Герой РФ, Лётчик-космонавт",
  ...
  question = new Question({
    author: "Баранов Дмитрий Александрович",
  ...
  question = new Question({
    author: "Авдеев Сергей Васильевич",
    whoAuthor: "Герой РФ, Лётчик-космонавт",
    name: "Война и космос",
  ...
  question = new Question({
    author: "Сердюк Александр Владимирович",
  ...
  question = new Question({
    author: "Федяев Андрей Валерьевич",
    whoAuthor: "Космонавт-испытатель Роскосмоса",
  ...
  question = new Question({
    author: "Тихонов Николай Владимирович",
    whoAuthor: "Космонавт-испытатель Роскосмоса",
    name: "Летающий танк",
